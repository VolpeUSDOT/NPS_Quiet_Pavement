...
- Update the treatment names in the table
- Repeat all for onboard measurements
- Compare results with original report draft
...
LZFeq_Chip.Seal.1.4 = ggplot()+
  geom_pointrange(data = LZFeq.aov.results,
                  aes(x = frequency,
                      y = treatmentX1.4in.Chip.Seal + treatmentX1.4in.Chip.Seal.speed * 50,
                      ymin = treatmentX1.4in.Chip.Seal + treatmentX1.4in.Chip.Seal.speed * 50 - LZFeq.aov.stderr$treatmentX1.4in.Chip.Seal,
                      ymax = treatmentX1.4in.Chip.Seal + treatmentX1.4in.Chip.Seal.speed * 50 + LZFeq.aov.stderr$treatmentX1.4in.Chip.Seal),
                  colour = CS_1.4_col,
                  size =1) +
  ...
  labs(title = "LZFeq ANOVA 1/4in Chip Seal Coefficients", 
       x = "Frequency (Hz)", 
       y = "Coefficient of Change in Sound \n Intensity from Pre-Treatment (dB)")  + 
...
LZFeq_Chip.Seal.3.8 = ggplot()+
  geom_pointrange(data = LZFeq.aov.results, 
                  aes(x = frequency,
                      y = treatmentX3.8in.Chip.Seal + treatmentX3.8in.Chip.Seal.speed * 50,
                      ymin = treatmentX3.8in.Chip.Seal + treatmentX3.8in.Chip.Seal.speed * 50 - LZFeq.aov.stderr$treatmentX3.8in.Chip.Seal,
                      ymax =treatmentX3.8in.Chip.Seal + treatmentX3.8in.Chip.Seal.speed * 50 + LZFeq.aov.stderr$treatmentX3.8in.Chip.Seal),
                  colour = CS_3.8_col,
                  size = 1) +
  theme_bw(base_line_size = 1,
           base_size = 20)+
...
LZFeq_Microsurfacing.II = ggplot()+
  geom_pointrange(data = LZFeq.aov.results,
                  aes(x = frequency, 
                  y = treatmentType.II.Microsurfacing + treatmentType.II.Microsurfacing.speed * 50,
                  ymin=treatmentType.II.Microsurfacing + treatmentType.II.Microsurfacing.speed * 50 - LZFeq.aov.stderr$treatmentType.II.Microsurfacing,
                  ymax=treatmentType.II.Microsurfacing + treatmentType.II.Microsurfacing.speed * 50 + LZFeq.aov.stderr$treatmentType.II.Microsurfacing),
...
LZFeq_Microsurfacing.III = ggplot()+
  geom_pointrange(data = LZFeq.aov.results,
                  aes(x = frequency, 
                  y = treatmentType.III.Microsurfacing + treatmentType.III.Microsurfacing.speed * 50,
                  ymin=treatmentType.III.Microsurfacing + treatmentType.III.Microsurfacing.speed * 50 - LZFeq.aov.stderr$treatmentType.III.Microsurfacing,
                  ymax=treatmentType.III.Microsurfacing + treatmentType.III.Microsurfacing.speed * 50 + LZFeq.aov.stderr$treatmentType.III.Microsurfacing),
