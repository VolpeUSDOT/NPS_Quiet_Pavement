...
LZFeq_Chip.Seal.1.4 = ggplot()+
  ...
  theme_bw(base_line_size = 1,
           base_size = 20)+
  scale_x_log10()+
  labs(title = '3-Year LZFeq ANOVA 1/4" Chip Seal Difference from Pre-treatment', 
       x = "Frequency (Hz)", 
       y = "LZFeq Difference \nfrom Pre-Treatment (dB)")  + 
  geom_hline(yintercept = 0) +
  ylim(y_range[1], y_range[2])
...
LZFeq_Chip.Seal.3.8 = ggplot()+
  ...
  theme_bw(base_line_size = 1,
           base_size = 20)+
  scale_x_log10()+
  labs(title = '3-Year LZFeq ANOVA 3/8" Chip Seal Difference from Pre-treatment', 
       x = "Frequency (Hz)", 
       y = "LZFeq Difference \nfrom Pre-Treatment (dB)")  + 
  geom_hline(yintercept = 0)+
  ylim(y_range[1], y_range[2])
...
LZFeq_Microsurfacing.II = ggplot()+
  ...
  theme_bw(base_line_size = 1,
           base_size = 20)+
  scale_x_log10()+
  labs(title = "3-Year LZFeq ANOVA Type II Microsurfacing Difference from Pre-treatment", 
       x = "Frequency (Hz)", 
       y = "LZFeq Difference \nfrom Pre-Treatment (dB)")  + 
  geom_hline(yintercept = 0)+
  ylim(y_range[1], y_range[2])
...
LZFeq_Microsurfacing.III = ggplot()+
  ...
  theme_bw(base_line_size = 1,
           base_size = 20)+
  scale_x_log10()+
  labs(title = "3-Year LZFeq ANOVA Type III Microsurfacing Difference from Pre-treatment", 
       x = "Frequency (Hz)", 
       y = "LZFeq Difference \nfrom Pre-Treatment (dB)")  + 
  geom_hline(yintercept = 0)+
  ylim(y_range[1], y_range[2])
...
point_plot <- ggplot(predvals, aes(x = frequency,
  ...
  theme_bw(base_line_size = 1,
           base_size = 15) +
  scale_x_log10() +
  labs(title = "3-Year LZFeq by Surface Treatment \nat 50mph vehicle speed & 90°F pavement temp", 
       x = "Frequency (Hz)", 
       y = "LZFeq (dB)")
