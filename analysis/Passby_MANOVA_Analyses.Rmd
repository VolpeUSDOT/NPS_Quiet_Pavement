...
LZFeq_Microsurfacing.II = ggplot()+
  ...
  theme_bw(base_line_size = 1,
           base_size = 20)+
  scale_x_log10()+
  labs(title = "Type II Microsurfacing", 
       x = "Frequency (Hz)", 
       y = "LZFeq Difference \nfrom Pre-Treatment (dB)")  + 
  geom_hline(yintercept = 0)+
  ylim(y_range[1], y_range[2])
...
LZFeq_Microsurfacing.III = ggplot()+
  ...
  theme_bw(base_line_size = 1,
           base_size = 20)+
  scale_x_log10()+
  labs(title = " Type III Microsurfacing", 
       x = "Frequency (Hz)", 
       y = "LZFeq Difference \nfrom Pre-Treatment (dB)")  + 
  geom_hline(yintercept = 0)+
  ylim(y_range[1], y_range[2])
...
## Arrange plots in grid
grid.arrange(LZFeq_Chip.Seal.1.4,LZFeq_Chip.Seal.3.8,LZFeq_Microsurfacing.II, LZFeq_Microsurfacing.III, nrow = 2,  top = textGrob("3.5-Year LZFeq ANOVA Difference from Pre-treatment", gp=gpar(fontsize=35)))
