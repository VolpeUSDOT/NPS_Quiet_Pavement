...
<!-- 
TODO:
- Validate calculation of predvals from coefficients for manual calculation
...
For the 2016 to 2016 comparison, all predictore remained significant, except that the interaction between pavement temperature and speed became only marginally significant (p = 0.058). The variable is retained here for comparison with the previous analysis of 2016 to 2018 data.
